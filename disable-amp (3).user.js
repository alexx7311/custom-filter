// ==UserScript==
// @name Disable AMP Beta
// @name:ar تعطيل AMP Beta
// @name:be Адключыць AMP Beta
// @name:bg Деактивирайте AMP Beta
// @name:bn-IN AMP নিষ্ক্রিয় করুন Beta
// @name:cs Zakázat AMP Beta
// @name:da Deaktiver AMP Beta
// @name:de AMP deaktivieren Beta
// @name:el Απενεργοποίηση AMP Beta
// @name:es Deshabilitar AMP Beta
// @name:et Keela AMP Beta
// @name:fa غيرفعالسازي شتاب دهنده صفحات موبایل Beta
// @name:fi Poista AMP käytöstä Beta
// @name:fr Désactiver AMP Beta
// @name:he AMP השבת Beta
// @name:hr Onemogući AMP Beta
// @name:hu AMP letiltása Beta
// @name:id Nonaktifkan AMP Beta
// @name:it Disattiva AMP Beta
// @name:ja AMPを無効化 Beta
// @name:ko AMP 비활성화 Beta
// @name:lt Išjungti AMP Beta
// @name:lv Atspējot AMP Beta
// @name:ms Nyahdayakan AMP Beta
// @name:ne-NP AMP लाई असक्षम पार्नुहोस् Beta
// @name:nl AMP uitschakelen Beta
// @name:no Skru av AMP Beta
// @name:pl Wyłącz AMP Beta
// @name:pt-PT Desativar AMP Beta
// @name:pt Desativar AMP Beta
// @name:ro Dezactivare AMP Beta
// @name:ru Отключить AMP Beta
// @name:sk Vypnúť AMP Beta
// @name:sl Onemogoči AMP Beta
// @name:sr Isključi sve Beta
// @name:sv Stäng av AMP Beta
// @name:tr AMP'yi devre dışı bırak Beta
// @name:uk Вимкнути AMP Beta
// @name:vi Vô hiệu hóa AMP Beta
// @name:zh-HK 停用 AMP Beta
// @name:zh-TW 禁用加速的行動頁面（AMP） Beta
// @name:zh 禁用 AMP Beta
// @namespace    adguard
// @version      1.0.45
...
// @downloadURL  https://userscripts.adtidy.org/beta/disable-amp/1.0/disable-amp.user.js
// @updateURL    https://userscripts.adtidy.org/beta/disable-amp/1.0/disable-amp.meta.js
...
// @run-at       document-end
// ==/UserScript==
!function(t){var e={};function r(n){if(e[n])return e[n].exports;var o=e[n]={i:n,l:!1,exports:{}};return t[n].call(o.exports,o,o.exports,r),o.l=!0,o.exports}r.m=t,r.c=e,r.d=function(t,e,n){r.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:n})},r.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},r.t=function(t,e){if(1&e&&(t=r(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var o in t)r.d(n,o,function(e){return t[e]}.bind(null,o));return n},r.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return r.d(e,"a",e),e},r.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},r.p="",r(r.s=0)}([function(t,e,r){"use strict";r.r(e);var n=/(amp\/|amp-|\.amp)/,o=function(t){new MutationObserver(t).observe(document,{childList:!0,subtree:!0})},a=function(t){var e=t.querySelector('[aria-label="AMP logo"], [aria-label="Logo AMP"]');e&&(e.style.display="none")},i=function(t,e){t.setAttribute("href",e),t.addEventListener("click",(function(t){t.preventDefault(),t.stopPropagation(),document.location.href=e}),!0),a(t)};function u(t){return function(t){if(Array.isArray(t))return c(t)}(t)||function(t){if("undefined"!=typeof Symbol&&null!=t[Symbol.iterator]||null!=t["@@iterator"])return Array.from(t)}(t)||function(t,e){if(!t)return;if("string"==typeof t)return c(t,e);var r=Object.prototype.toString.call(t).slice(8,-1);"Object"===r&&t.constructor&&(r=t.constructor.name);if("Map"===r||"Set"===r)return Array.from(t);if("Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r))return c(t,e)}(t)||function(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function c(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,n=new Array(e);r<e;r++)n[r]=t[r];return n}var l=/^https?:\/\/.+/i,s="__".concat(Math.random()),f=function(){u(document.querySelectorAll("a[data-amp-cur]")).forEach((function(t){if(!t[s]){t[s]=!0;var e=t.getAttribute("data-amp-cur")||t.getAttribute("data-amp");if(e)i(t,e.replace(n,""));else{var r=t.href;r&&r.includes("articleViewAmp")&&i(t,r.replace("articleViewAmp","articleView"))}}}))},d=document.location,p=d.href,m=d.origin;p.includes("https://yandex.ru/turbo")||p.includes("turbopages.org")?function(){var t=document.querySelector('script[data-name="post-message"][data-message]');if(t){var e=t.getAttribute("data-message"),r=JSON.parse(e);r&&r.originalUrl&&(document.location.href=r.originalUrl)}}():m.includes("news.google.")?o((function(){window.self===window.top&&document.querySelectorAll("article > a[jslog]").forEach((function(t){var e=function(t){var e,r=t.substring(t.indexOf(":")+1,t.indexOf("; track:click,vis"));try{e=JSON.parse(atob(r))}catch(t){}if(!e)return null;var o=e.filter((function(t){return"string"==typeof t&&(t.startsWith("http")||t.startsWith("https"))}));return o.length<2?null:o.find((function(t){return!n.test(t)}))||null}(t.getAttribute("jslog"));e&&i(t,e)}))})):m.includes(".google.")?o((function(){f(),document.querySelectorAll("a[data-amp-cdn]").forEach((function(t){var e=t.href;e.includes("cdn.ampproject.org")&&(e="https://"+e.substr(e.indexOf("cdn.ampproject.org/wp/s/")+24)),e.substr(8).startsWith("amp.")&&(e="https://"+e.substr(12)),(e=e.replace("?amp&","?&"))!==t.href&&(t.setAttribute("href",e),t.addEventListener("click",(function(t){t.preventDefault(),t.stopPropagation(),document.location.href=e}),!0),a(t))}))})):function(){var t=Number(sessionStorage.getItem("__disable_amp_redirected"));if(!(window.self!==window.top||t&&Date.now()-t<3e4)){var e=document.querySelector('head > link[rel="canonical"]');document.querySelector('head > script[src^="https://cdn.ampproject.org"]')&&e&&l.test(e.href)&&(sessionStorage.setItem("__disable_amp_redirected",Date.now()),window.top.location.href=e.href)}}()}]);